...
final_rf <- ranger_workflow %>% 
  finalize_workflow(select_best(ranger_tune, "roc_auc"))# acc
final_rf
```
<br>
...
final_glmnet <- glmnet_workflow %>% 
  finalize_workflow(select_best(glmnet_tune, "accuracy")) #roc_auc
final_glmnet
```
<br>
...
final_kknn <- kknn_workflow %>% 
  finalize_workflow(select_best(kknn_tune, "roc_auc"))# acc
final_kknn
```
